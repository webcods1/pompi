                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full bg-white/10 border border-white/20 text-white text-sm rounded-lg py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400/50 transition-all [color-scheme:dark]"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white/10 border border-white/20 text-white text-sm placeholder:text-white/40 rounded-lg py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400/50 transition-all"
                                        />
                                    </div>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            rows={2}
                                            placeholder="E.g., Honeymoon trip, wheelchair access, vegetarian meals..."
                                            className="w-full bg-white/10 border border-white/20 text-white text-sm placeholder:text-white/40 rounded-lg py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400/50 transition-all resize-none"
                                        />
                                    </div>
                                </div>

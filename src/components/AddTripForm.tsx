                        ...
                        <div>
                            ...
                            <div className="flex gap-3">
                                <input
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="flex-1 min-w-0 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                                    placeholder="https://..."
                                />
                                {formData.image && (
                                    <div className="w-24 h-[50px] shrink-0 bg-gray-100 rounded-lg overflow-hidden border border-gray-200 group relative self-center">
                                        <img
                                            src={formData.image}
                                            alt="Preview"

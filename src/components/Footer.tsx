            ...
            <div className="relative">
                ...
                <div className="container mx-auto px-2 md:px-4 relative z-10">
                    <div className="flex flex-wrap md:flex-nowrap">
                        ...
                        <div className="w-full md:w-1/4 p-3 md:p-6 flex flex-col items-start text-left">
                            <div className="mb-2 md:mb-4">
                                <img src="/logo2.png" alt="Logo" className="h-7 md:h-10 w-auto object-contain" />
                            </div>

                            <p className="text-gray-600 text-[9px] md:text-xs leading-relaxed mb-3 md:mb-6 max-w-xs">
                            ...
                            <div className="flex space-x-2 md:space-x-3">
                                ...
                                <a href="#" className="w-6 h-6 md:w-8 md:h-8 rounded-full border border-gray-100 flex items-center justify-center hover:bg-red-50 transition-all duration-300 group bg-white shadow-sm hover:scale-110">
                                    <svg className="w-3 h-3 md:w-4 md:h-4 text-gray-400 group-hover:text-red-600" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="#" className="w-6 h-6 md:w-8 md:h-8 rounded-full border border-gray-100 flex items-center justify-center hover:bg-red-50 transition-all duration-300 group bg-white shadow-sm hover:scale-110">
                                    <svg className="w-3 h-3 md:w-4 md:h-4 text-gray-400 group-hover:text-green-600" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="w-full md:w-3/4 p-3 md:p-6 grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 text-gray-900">
                            <div>
                                <h4 className="text-[10px] md:text-sm font-bold mb-2 md:mb-4 uppercase tracking-wider text-red-500">Company</h4>
                                <ul className="space-y-2 md:space-y-4 text-gray-600 text-[9px] md:text-sm">
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">About Our Story</a></li>
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Meet The Team</a></li>
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Success Stories</a></li>
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Travel Blog</a></li>
                                </ul>
                            </div>

                            <div>
                                <h4 className="text-[10px] md:text-sm font-bold mb-2 md:mb-4 uppercase tracking-wider text-red-500">Fast Reach</h4>
                                <ul className="space-y-2 md:space-y-4 text-gray-600 text-[9px] md:text-sm">
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Book A Hotel</a></li>
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Tour Packages</a></li>
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Flight Tickets</a></li>
                                    <li><a href="#" className="hover:text-red-600 transition-colors duration-300">Contact Support</a></li>
                                </ul>
                            </div>

                            <div>
                                <h4 className="text-[10px] md:text-sm font-bold mb-2 md:mb-4 uppercase tracking-wider text-red-500">Office Location</h4>
                                <div className="space-y-2 md:space-y-4 text-gray-600 text-[8px] md:text-xs leading-relaxed">

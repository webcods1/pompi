    ...
    useEffect(() => {
        ...
        const timer = setInterval(() => {
            setVisibleItems((prev) => {
                // We go up to length + 1 to ensure the last dot turns red
    ...
    return (
        <div className="absolute left-8 md:left-24 top-[60%] -translate-y-1/2 z-30 flex flex-col items-start gap-8 py-4">
            ...
            {destinations.map((dest, index) => (
                <div key={dest.id} className="flex items-center gap-6 relative group">
